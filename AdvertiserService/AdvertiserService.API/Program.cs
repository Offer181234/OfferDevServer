...
Log.Information("AdvertiserService - Starting Application");
...
// ---------------- DATABASE ----------------
builder.Services.AddDbContext<AdvertiserDbContext>(options =>
...
builder.Services.AddScoped<IAdvertiserService, AdvertiserServices>();
...
{
    options.RoutePrefix = "Advertiser/swagger";
    options.SwaggerEndpoint("/swagger/v1/swagger.json", "Advertiser API V1");
});
...
{
    await context.Response.WriteAsync("Listening Advertiser Service....");
});

Log.Information("AdvertiserService - Application Ready");
